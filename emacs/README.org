...
[i] Server advertises HTTP/3 support via Alt-Svc
#+end_example
...
[*] Connecting to httpbin.org:443 (TLS)
HTTP/1.1 200 OK
Date: Sat, 31 Jan 2026 00:30:00 GMT
Content-Type: text/html; charset=utf-8

[*] Timing breakdown:
DNS lookup:      22.454ms
TCP connect:     39.809ms
TLS handshake:   28.810ms
Request send:    0.006ms
Server processing: 23.894ms
Content download: 0.046ms
Total:           115.028ms
#+end_example
...
[*] Using host from request: httpbin.org
[*] Connecting to httpbin.org:443 (TLS)
[*] Following redirect (1/10): /redirect/2
[*] Following redirect (2/10): /redirect/1
[*] Following redirect (3/10): /get
{
  "args": {},
  "headers": {
    "Host": "httpbin.org"
